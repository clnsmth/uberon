...
def main():
    ...
    prompt = f"""You are a completion verifier for the Uberon AI agent (@clnsmth-ai-agent). Your job is to check whether the agent actually completed its task before allowing it to stop.
